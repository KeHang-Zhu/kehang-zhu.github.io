...
Currently, I'm diving deep into my third year of PhD studies at [Harvard University's esteemed Physics Department](https://www.physics.harvard.edu/). My research is studying Large Language Models in experimental economics setting🎩✨
...
I am interested in decision making, information eliciting and mechanism design (specifically auction design). And their emperical study with Large language models as subjects.

In the short term,, I am exploring these two directions:
1. Do LLMs behave like humans? How? When?
2. Do humans behave like LLMs? How can we use LLMs to inform new machenism design.
